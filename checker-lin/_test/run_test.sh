...
test_fun_array=(							\
	test_coding_style	"Sources check"			0	\
	test_exec		"Test simple execution"		6	\
	test_hello		"Test hello"			11	\
	test_sum		"Test sum"			11	\
	test_bss		"Test bss"			11	\
	test_data_bss		"Test data and bss"		11	\
